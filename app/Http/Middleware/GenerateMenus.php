...
class GenerateMenus
{
    ...
    public function handle($request, Closure $next)
    {
        \Menu::make('admin_sidebar', function ($menu) {
            ...
            // Job Post
            $menu->add('<i class="nav-icon fa fa-users"></i> Job Post', [
                'route' => 'backend.jobposts.index',
                'class' => 'nav-item',
            ])
            ->data([
                'order'         => 99,
                'activematches' => 'admin/jobposts*',
                'permission'    => ['view_jobposts'],
            ])
            ->link->attr([
                'class' => 'nav-link',
            ]);
            ...
            // Carousels
            $menu->add('<i class="nav-icon fa fa-th"></i> Clients Logos', [
                'route' => 'backend.carousels.index',
                'class' => 'nav-item',
            ])
            ->data([
                'order'         => 100,
                'activematches' => 'admin/carousels*',
            ...
            $accessControl = $menu->add('<i class="nav-icon fa fa-user-plus"></i> Access Control', [
            ...
            // Submenu: Users
            $accessControl->add('<i class="nav-icon fa fa-user-secret"></i> Users', [
            ...
            // Submenu: Roles
            $accessControl->add('<i class="nav-icon fa fa-link"></i> Roles', [
