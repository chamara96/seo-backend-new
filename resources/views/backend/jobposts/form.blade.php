        ...
        <div class="form-group">
            ...
            <div class="input-group mb-3">
                ...
                <!-- <div class="input-group-append">
                    ...
                    <input id="file-multiple-input" name="featured_image" multiple="" type="file">
                </div> -->
            </div>
        </div>
    </div>
...
<script type="text/javascript">
    ...
    CKEDITOR.replace('content', {
        filebrowserUploadUrl: "{{route('backend.upload_job', ['_token' => csrf_token() ])}}",
